  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        if (data.user.subscription_plan === 'basic') {
          router.push('/chat');
        } else {
          router.push('/chat');
        }
          ...
          <form onSubmit={handleVerify} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent text-center text-2xl font-mono tracking-widest"
                placeholder="000000"
                maxLength={6}
                required
              />
