          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="max-w-2xl mx-auto relative">
              <input
                ...
                className="w-full px-6 py-4 text-lg border border-gray-300 rounded-xl focus:ring-2 focus:ring-gold-500 focus:border-gold-500 shadow-sm"
              />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3">
                  ...
                  {filteredFAQs.map((faq, index) => (
                    <div key={index} className="bg-white rounded-lg shadow-sm border border-gray-200">
                      <button
                        ...
                        className="w-full text-left px-6 py-4 focus:outline-none focus:ring-2 focus:ring-gold-500 focus:ring-inset"
                      >
              ...
              <SupportSection
                ...
                showLinks={true}
                className="mt-12 bg-gradient-to-r from-amber-50 to-gold-50 rounded-lg p-8 text-center"
              />
            </div>
          </div>
        </div>
