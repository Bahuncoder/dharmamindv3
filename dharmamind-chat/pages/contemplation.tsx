  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900">
        {/* Header */}
        <header className="bg-white/95 dark:bg-neutral-800/95 backdrop-blur-sm border-b border-neutral-200 dark:border-neutral-700 sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-4">
                <Link href="/chat" className="flex items-center text-neutral-600 dark:text-neutral-300 hover:text-gold-600 dark:hover:text-gold-400 transition-colors">
                  <ArrowLeftIcon className="h-5 w-5 mr-2" />
                  Back to Chat
                </Link>
                <div className="h-6 border-l border-neutral-300 dark:border-neutral-600"></div>
                <h1 className="text-xl font-semibold text-neutral-900 dark:text-white flex items-center">
                  <HeartIcon className="h-6 w-6 text-gold-500 mr-2" />
                  Deep Contemplation
                </h1>
              </div>
              <div className="flex items-center space-x-2">
                <LightBulbIcon className="h-5 w-5 text-gold-500" />
                <span className="text-sm text-neutral-600 dark:text-neutral-400">AI-Guided Spiritual Practice</span>
              </div>
            </div>
          </div>
        </header>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8 bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 p-6">
            <div className="text-center">
              ...
              <p className="text-neutral-600 dark:text-neutral-300 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white dark:bg-neutral-800 rounded-lg p-6 border border-neutral-200 dark:border-neutral-700 shadow-sm">
              <div className="text-center">
                <div className="bg-gold-100 dark:bg-gold-900/30 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4">
                  <HeartIcon className="h-6 w-6 text-gold-600 dark:text-gold-400" />
                </div>
                <h3 className="text-lg font-semibold text-neutral-900 dark:text-white mb-2">Personalized Guidance</h3>
            ...
            <div className="bg-white dark:bg-neutral-800 rounded-lg p-6 border border-neutral-200 dark:border-neutral-700 shadow-sm">
              <div className="text-center">
                <div className="bg-gold-100 dark:bg-gold-900/30 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-gold-600 dark:text-gold-400 text-lg font-bold">ॐ</span>
                </div>
                <h3 className="text-lg font-semibold text-neutral-900 dark:text-white mb-2">Sanskrit Wisdom</h3>
                <p className="text-neutral-600 dark:text-neutral-300 text-sm">
            ...
            <div className="bg-white dark:bg-neutral-800 rounded-lg p-6 border border-neutral-200 dark:border-neutral-700 shadow-sm">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-neutral-900 dark:text-white mb-2">Deep Insights</h3>
                <p className="text-neutral-600 dark:text-neutral-300 text-sm">
