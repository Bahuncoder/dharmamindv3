          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <div className="prose prose-gray max-w-none">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">Welcome to DharmaMind</h2>
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-3">Ancient Wisdom</h3>
                <p className="text-gray-700">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">AI Limitations & Disclaimers</h2>
              ...
              <section className="mb-8">
                ...
                <div className="bg-gray-100 rounded-lg p-4">
                  <p className="text-gray-800"><strong>Email:</strong> legal@dharmamind.com</p>
                  <p className="text-gray-800"><strong>Support:</strong> support@dharmamind.com</p>
                  <p className="text-gray-800"><strong>Address:</strong> DharmaMind Legal Team</p>
                </div>
              </section>
