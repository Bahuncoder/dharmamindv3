        ...
        >
          ...
          <div className="px-4 py-3">
            ...
            <button
              ...
              style={{
                background: 'linear-gradient(135deg, var(--brand-secondary, #d4a854) 0%, var(--color-accent-light, #e4b864) 100%)',
                boxShadow: '0 4px 14px 0 rgba(212, 168, 84, 0.3)'
              }}
            >
        ...
        <div className="px-4 py-3 border-b border-gray-100 bg-gradient-to-r from-neutral-100 to-gold-50">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1">
              ...
              <div className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium mt-1 ${(user.subscription_plan || user.plan) === 'basic'
