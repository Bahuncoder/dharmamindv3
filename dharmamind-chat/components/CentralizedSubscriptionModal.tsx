        ...
        <div className="p-6">
          ...
          <div className="flex justify-center mb-8">
            <div className="flex items-center bg-gray-100 rounded-lg p-1">
              ...
              >
                Yearly
                <span className="ml-2 bg-success-100 text-green-800 text-xs px-2 py-1 rounded-full">
          ...
          {success && (
            <div className="mb-6 bg-success-50 border border-green-200 rounded-lg p-4">
              <div className="flex">
                ...
                >
                  {isPopular && (
                    <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                      <span className="bg-gradient-to-r from-amber-500 to-gold-500 text-white px-4 py-1 rounded-full text-sm font-medium">
                        Most Popular
                      </span>
                    </div>
                  )}
                    ...
                    <ul className="space-y-3 mb-6">
                      {plan.features.map((feature, index) => (
                        <li key={index} className="flex items-center">
                          <svg
                            className={`w-5 h-5 mr-3 ${feature.included ? 'text-success-500' : 'text-gray-300'
                              }`}
                            fill="currentColor"
                            viewBox="0 0 20 20"
                          >
                    ...
                    <button
                      ...
                      className={`w-full py-3 px-4 rounded-lg font-medium transition-colors ${isCurrentPlan
                          ...
                          : processing
                            ...
                            : isPopular
                              ? 'bg-gradient-to-r from-amber-600 to-gold-600 text-white hover:from-amber-700 hover:to-gold-700'
