    ...
    <div className="bg-white border-l border-gray-200 h-full flex flex-col">
      ...
      <div className="p-4 border-b border-gray-100">
        <div className="flex items-center justify-between">
          <h3 className="text-sm font-semibold text-gray-900">Guide</h3>
          <button
        ...
        {!selectedRishi && (
          <div className="mt-3 flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-medium text-gray-900">DharmaMind</div>
              <div className="text-xs text-gray-500">Spiritual wisdom assistant</div>
            </div>
          </div>
        )}
      </div>
          ...
          >
            <div className="p-3 space-y-1">
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 p-2.5 rounded-lg text-left transition-all ${!selectedRishi
                    ? 'bg-gold-50 border border-gold-200'
                    : 'hover:bg-gray-50 border border-transparent'
                  }`}
              >
                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${!selectedRishi ? 'bg-gold-100' : 'bg-gray-100'
                  }`}>
              ...
              {availableRishis.map(rishi => {
                ...
                return (
                  <button
                    ...
                    disabled={isLocked}
                    className={`w-full flex items-center gap-3 p-2.5 rounded-lg text-left transition-all ${isSelected
                        ? 'bg-gold-50 border border-gold-200'
                        : isLocked
