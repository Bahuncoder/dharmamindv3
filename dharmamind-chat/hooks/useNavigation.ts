...
import { getRedirectDestination } from '../utils/redirects';
...
export const ROUTES = {
  // Public pages
  HOME: '/', // Main landing page as the entry point
  AUTH: '/auth',
  CONTACT: '/contact',
  HELP: '/help',
  ABOUT: '/about',
  ...
  PROFILE: '/profile',
  SETTINGS: '/settings',
  SUBSCRIPTION: '/chat?subscription=true', // Centralized subscription modal
  BILLING: '/chat?subscription=true', // Same as subscription
...
export const useNavigation = (): UseNavigationReturn => {
  ...
  // Route-specific helpers
  const goHome = useCallback(() => navigateTo('/chat?demo=true'), [navigateTo]);
...
/**
 * Smart navigation function that handles redirects automatically
 */
