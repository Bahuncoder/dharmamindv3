...
class AuthenticSourceValidator:
    ...
    def _load_contamination_patterns(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            "buddhist_mixing": [
                "buddhist meditation in hinduism", "mindfulness is dharmic",
                "buddha as hindu god", "zen dharma", "buddhist yoga"
            ]
        }
    ...
    def _generate_flags(self, text: str, source: str, 
        ...
        if any(pattern in text_lower for pattern in self.contamination_patterns["buddhist_mixing"]):
