...
class KamaModule:
    ...
    - Buddhist insights on the nature of craving
    ...
    def get_scriptural_wisdom(self, level: KamaLevel) -> str:
        ...
        wisdom_map = {
            ...
            KamaLevel.AWARE: "Buddha: 'The root of suffering is attachment to desires. Observe desires arising and passing without identification.'",
