...
from .dharmic.personalization_engine import get_personalization_engine
from .dharmic.practice_recommendation_engine import get_practice_recommendation_engine

# Try to import consciousness core, use fallback if not available
try:
...
class PersonalizationIntegration:
    ...
    def __init__(self):
        ...
        if not CONSCIOUSNESS_AVAILABLE:
            self.logger.warning("⚠️ Consciousness core dependencies not available - using fallback")
