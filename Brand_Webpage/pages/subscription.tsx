...
const SubscriptionPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-amber-50 to-stone-50 flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-amber-600 mx-auto mb-4"></div>
          <p className="text-secondary">Redirecting to pricing...</p>
        </div>
      </div>
    </>
  );
