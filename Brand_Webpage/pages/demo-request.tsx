...
const DemoRequestPage: React.FC = () => {
  ...
  if (submitted) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-stone-50 via-gray-50 to-emerald-50">
        <Head>
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <div className="bg-white rounded-lg p-8 shadow-sm border border-stone-200 mb-8">
              ...
              <div className="bg-primary-clean rounded-lg p-4 border border-stone-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={() => router.push('/')}
                className="bg-gray-500 hover:bg-gray-600 text-white px-6 py-3 rounded-lg font-medium border-2 border-emerald-500 hover:border-emerald-600 transition-all duration-300"
              >
                Back to Home
              </button>
              <button
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-6 border-t border-gray-200">
              <button
                ...
                className={`w-full bg-gray-500 text-white px-8 py-4 rounded-lg text-lg font-medium transition-all duration-300 shadow-lg border-2 border-emerald-500 ${
                  isSubmitting 
                    ? 'opacity-50 cursor-not-allowed' 
                    : 'hover:bg-gray-600 hover:border-emerald-600 hover:shadow-xl'
                }`}
              >
                {isSubmitting ? (
