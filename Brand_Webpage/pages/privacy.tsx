          ...
          <div className="bg-white rounded-lg shadow-sm border border-light p-8">
            ...
            <div className="prose prose-gray max-w-none">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-primary mb-4">Our Commitment to Privacy</h2>
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold text-primary mb-3">Conversation Data</h3>
                <ul className="list-disc list-inside text-primary mb-4 space-y-2">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-primary mb-4">Data Protection & Security</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-primary mb-4">Your Privacy Rights</h2>
                <p className="text-primary mb-4">You have the following rights regarding your personal data:</p>
                <ul className="list-disc list-inside text-primary space-y-2">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-primary mb-4">Chat History & User Control</h2>
                <p className="text-primary mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-primary mb-4">Cookies & Analytics</h2>
                <p className="text-primary mb-4">
              ...
              <section className="mb-8">
                ...
                <div className="bg-brand-primary rounded-lg p-4">
                  <p className="text-primary"><strong>Email:</strong> privacy@dharmamind.com</p>
                  <p className="text-primary"><strong>Support:</strong> support@dharmamind.com</p>
                  <p className="text-primary"><strong>Address:</strong> DharmaMind Privacy Team</p>
                </div>
              </section>
