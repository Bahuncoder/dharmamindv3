...
export default function PrivacyPage() {
  return (
    <Layout title="Privacy Policy" description="DharmaMind Privacy Policy - How we protect and handle your data">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-neutral max-w-none">
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">Our Commitment to Privacy</h2>
            ...
            <section className="mb-12">
              ...
              <h3 className="text-xl font-semibold text-neutral-900 mb-3">Conversation Data</h3>
              <ul className="list-disc list-inside text-neutral-600 mb-6 space-y-2">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">Data Protection & Security</h2>
              <div className="bg-gold-50 border border-gold-200 rounded-lg p-4 mb-6">
                <p className="text-gold-700 font-medium">🔒 Your spiritual conversations are encrypted and protected</p>
              </div>
              <ul className="list-disc list-inside text-neutral-600 space-y-2">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">Your Privacy Rights</h2>
              <p className="text-neutral-600 mb-4">You have the following rights regarding your personal data:</p>
              <ul className="list-disc list-inside text-neutral-600 space-y-2">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">Chat History & User Control</h2>
              <p className="text-neutral-600 mb-4">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">Data Sharing</h2>
              <p className="text-neutral-600 mb-4">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold text-neutral-900 mb-4">Cookies & Analytics</h2>
              <p className="text-neutral-600 mb-4">
            ...
            <section className="mb-12">
              ...
              <div className="bg-neutral-100 border border-neutral-200 rounded-lg p-4">
                <p className="text-neutral-700"><strong>Email:</strong> privacy@dharmamind.com</p>
