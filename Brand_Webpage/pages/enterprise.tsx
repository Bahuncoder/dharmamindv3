  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-primary-100">
        ...
        {/* Simplified Professional Hero Section */}
        <div className="relative bg-primary-50 border-b-2 border-accent-500 overflow-hidden">
          {/* Clean Background Pattern */}
          <div className="absolute inset-0 opacity-5">
            <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-accent-500 rounded-full blur-3xl"></div>
            <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-accent-500 rounded-full blur-3xl"></div>
          </div>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            ...
            >
              <motion.div
                ...
                className="inline-flex items-center px-6 py-3 bg-primary-100 border-2 border-accent-500 rounded-full mb-8"
              >
                <span className="text-accent-500 mr-2">🏢</span>
                <span className="text-sm font-medium text-primary-800">Enterprise-Grade AI Wisdom Platform</span>
              </motion.div>

              <h1 className="text-6xl lg:text-7xl font-bold mb-6 text-primary-800">
                DharmaMind for
                <br />
                <span className="text-accent-500 border-b-4 border-accent-500">
                  Enterprise
                </span>
              </h1>

              <p className="text-xl lg:text-2xl text-primary-600 mb-8 max-w-4xl mx-auto leading-relaxed">
              ...
              <div className="flex flex-col lg:flex-row gap-6 justify-center mb-12">
                ...
                >
                  <Button
                    ...
                    className="bg-primary-100 border-2 border-accent-500 hover:bg-primary-200 text-primary-800 px-10 py-4 text-lg font-semibold rounded-xl"
                  >
                ...
                >
                  <Button
                    ...
                    className="bg-accent-500 hover:bg-accent-600 text-white px-10 py-4 text-lg font-semibold rounded-xl border-2 border-accent-500"
                  >
                    <span className="mr-2">📋</span>
              ...
              <motion.div
                ...
                className="flex flex-wrap items-center justify-center gap-8 text-sm text-primary-600"
              >
                <div className="flex items-center space-x-2 px-4 py-2 bg-primary-100 border border-accent-500 rounded-lg">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
              ...
              >
                ...
                <div className="text-sm text-secondary">Enterprise Clients</div>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div className="text-sm text-secondary">Users Supported</div>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div className="text-sm text-secondary">Reduction in Turnover</div>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div className="text-sm text-secondary">Platform Uptime</div>
              </motion.div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            >
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-8 h-full hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]">
                ...
                <h3 className="text-2xl font-bold text-primary mb-4">DharmaMind for Teams</h3>
                ...
                <div className="space-y-4 mb-8">
                  <h4 className="font-semibold text-primary mb-3">Enterprise Features:</h4>
            ...
            >
              <div className="bg-gradient-to-br from-purple-50 to-violet-50 border-2 border-purple-300 rounded-2xl p-8 h-full hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] relative">
                ...
                <h3 className="text-2xl font-bold text-primary mb-4">DharmaMind Karma</h3>
                ...
                <div className="space-y-4 mb-8">
                  <h4 className="font-semibold text-primary mb-3">Leadership Tools:</h4>
                  <div className="space-y-3 text-sm text-primary">
                    <div className="flex items-start space-x-3">
                      <span className="text-green-500 mt-0.5">✓</span>
                      <div>
            ...
            >
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-200 rounded-2xl p-8 h-full hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02]">
                ...
                <h3 className="text-2xl font-bold text-primary mb-4">DharmaMind Pathways</h3>
                ...
                <div className="space-y-4 mb-8">
                  <h4 className="font-semibold text-primary mb-3">Talent Solutions:</h4>
                  <div className="space-y-3 text-sm text-primary">
                    <div className="flex items-start space-x-3">
                      <span className="text-green-500 mt-0.5">✓</span>
                      <div>
        ...
        <div className="bg-section-light py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-primary mb-2">End-to-End Encryption</h3>
                    <p className="text-secondary">All data encrypted in transit and at rest using AES-256 encryption with customer-managed keys.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-primary mb-2">Zero-Trust Architecture</h3>
                    <p className="text-secondary">Multi-layered security with continuous verification and least-privilege access controls.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-primary mb-2">Enterprise SSO</h3>
                    <p className="text-secondary">SAML 2.0, OpenID Connect, and OAuth 2.0 integration with all major identity providers.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-primary mb-2">Advanced Threat Detection</h3>
                    <p className="text-secondary">Real-time monitoring with AI-powered anomaly detection and automated response systems.</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-primary mb-2">SOC 2 Type II Certified</h3>
                    <p className="text-secondary">Annual third-party audits ensuring the highest standards of security and availability.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-primary mb-2">GDPR & CCPA Compliant</h3>
                    <p className="text-secondary">Full compliance with global privacy regulations including data portability and right to deletion.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-primary mb-2">HIPAA Ready</h3>
                    <p className="text-secondary">Healthcare-grade privacy controls with Business Associate Agreements available.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-primary mb-2">Complete Audit Trails</h3>
                    <p className="text-secondary">Comprehensive logging and monitoring with tamper-proof audit trails for compliance reporting.</p>
                  </div>
                </div>
              </motion.div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <h3 className="text-2xl font-semibold text-primary mb-4">Multi-Cloud SaaS</h3>
                ...
                <div className="space-y-3 text-sm text-primary mb-8 text-left">
              ...
              >
                ...
                <h3 className="text-2xl font-semibold text-primary mb-4">Private Cloud</h3>
                <p className="text-secondary mb-6 leading-relaxed">
              ...
              >
                ...
                <h3 className="text-2xl font-semibold text-primary mb-4">On-Premise</h3>
                <p className="text-secondary mb-6 leading-relaxed">
        ...
        {/* Pricing - Simplified Color System */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-primary-50">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-primary-800 mb-4 border-b-4 border-accent-500 inline-block pb-2">
              Enterprise Pricing
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {pricingTiers.map((tier, index) => (
              <div key={index} className={`relative rounded-xl p-8 ${tier.popular
                ? 'bg-primary-100 border-4 border-accent-500'
                ...
                <div className="text-center">
                  <h3 className="text-xl font-semibold text-primary-800 mb-2">{tier.name}</h3>
                  <div className="mb-4">
                    <span className="text-4xl font-bold text-accent-500">{tier.price}</span>
                    <span className="text-primary-600"> {tier.period}</span>
                  </div>
                ...
                <Button
                  className={`w-full ${tier.popular
                    ...
                    : 'bg-primary-100 hover:bg-primary-200 text-primary-800 border-2 border-accent-500'
                    }`}
                  onClick={() => router.push('/demo-request')}
                >
                  {tier.cta}
        ...
        {/* Enterprise ROI Calculator - Updated Colors */}
        <div className="bg-primary-200 border-t-4 border-accent-500 py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="text-center mb-16"
            >
              <h2 className="text-4xl font-bold mb-6 text-primary-800 border-b-4 border-accent-500 inline-block pb-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6">
                  ...
                  <div className="text-secondary text-sm">For 1,000+ employee organizations</div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white/10 backdrop-blur-xl rounded-xl p-4">
                    ...
                    <div className="text-sm text-secondary">Turnover Reduction</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-xl rounded-xl p-4">
                    <div className="text-2xl font-bold text-purple-400 mb-1">62%</div>
                    <div className="text-sm text-secondary">Engagement Increase</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-xl rounded-xl p-4">
                    <div className="text-2xl font-bold text-green-400 mb-1">34%</div>
                    <div className="text-sm text-secondary">Better Decisions</div>
                  </div>
                  <div className="bg-white/10 backdrop-blur-xl rounded-xl p-4">
                    <div className="text-2xl font-bold text-yellow-400 mb-1">18M</div>
                    <div className="text-sm text-secondary">Recovery Time</div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-brand-primary/20 to-brand-accent/20 backdrop-blur-xl rounded-2xl p-6 border border-white/20">
                  ...
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                      <span className="text-secondary">Reduced Hiring Costs</span>
                      <span className="text-white font-medium">$850K/year</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-secondary">Improved Productivity</span>
                      <span className="text-white font-medium">$1.2M/year</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-secondary">Better Decision Making</span>
        ...
        <div className="bg-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <div className="font-semibold text-lg text-primary">Global Financial Services</div>
                ...
                <div className="grid grid-cols-2 gap-4 text-center text-sm">
                  <div className="bg-white rounded-lg p-3">
                    ...
                    <div className="text-secondary">Fewer Compliance Issues</div>
                  </div>
                  <div className="bg-white rounded-lg p-3">
                    <div className="text-2xl font-bold text-green-600">$12M</div>
                    <div className="text-secondary">Annual Savings</div>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <div className="font-semibold text-lg text-primary">Healthcare Network</div>
                ...
                <div className="grid grid-cols-2 gap-4 text-center text-sm">
                  <div className="bg-white rounded-lg p-3">
                    ...
                    <div className="text-secondary">Reduced Burnout</div>
                  </div>
                  <div className="bg-white rounded-lg p-3">
                    <div className="text-2xl font-bold text-green-600">89%</div>
                    <div className="text-secondary">Staff Satisfaction</div>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <div className="font-semibold text-lg text-primary">Technology Unicorn</div>
                ...
                <div className="grid grid-cols-2 gap-4 text-center text-sm">
                  <div className="bg-white rounded-lg p-3">
                    ...
                    <div className="text-secondary">Internal Promotions</div>
                  </div>
                  <div className="bg-white rounded-lg p-3">
                    <div className="text-2xl font-bold text-green-600">91%</div>
                    <div className="text-secondary">Employee Retention</div>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <motion.div
              ...
              className="text-center"
            >
              <p className="text-secondary mb-8">Trusted across industries</p>
              <div className="flex flex-wrap justify-center items-center gap-12 opacity-60">
                <div className="text-2xl font-bold text-secondary">🏦 Financial Services</div>
                <div className="text-2xl font-bold text-secondary">🏥 Healthcare</div>
                <div className="text-2xl font-bold text-secondary">⚡ Technology</div>
                <div className="text-2xl font-bold text-secondary">🏭 Manufacturing</div>
                <div className="text-2xl font-bold text-secondary">🎓 Education</div>
              </div>
            </motion.div>
          </div>
        </div>
