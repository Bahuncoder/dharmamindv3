    ...
    <footer className={`bg-white border-t border-gray-100 ${className}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex space-x-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 bg-slate-100 rounded-full flex items-center justify-center text-slate-600 hover:bg-gray-200 hover:text-primary transition-all duration-200"
                  aria-label="Follow us on Facebook"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <button 
                  onClick={() => handleAnchorLink('#features')} 
                  className="text-slate-600 hover:text-slate-900 text-left block text-sm transition-colors"
                >
                  Features
                </button>
              </li>
          ...
          {/* Support Section */}
          <div>
            <h3 className="text-sm font-semibold text-slate-900 mb-4 uppercase tracking-wider">Support</h3>
            <ul className="space-y-3">
              <li>
                <button 
                  onClick={() => handleNavigation('/help')} 
              ...
              <li>
                <ContactButton 
                  ...
                  showIcon={false}
                  className="!text-slate-600 hover:!text-slate-900 !text-left !block !text-sm !transition-colors !no-underline !justify-start !w-full !font-normal !p-0 !m-0"
                >
                  Contact Support
                </ContactButton>
              </li>
