...
const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-amber-600 to-emerald-600 text-white hover:from-amber-700 hover:to-emerald-700 shadow-md hover:shadow-lg focus:ring-amber-500/50',
    secondary: 'bg-white text-gray-900 border border-gray-200 hover:bg-gray-50 focus:ring-gray-500/50',
    outline: 'border border-gray-300 text-gray-700 hover:bg-gray-50 focus:ring-gray-500/50',
    contact: 'bg-blue-600 text-white hover:bg-blue-700 focus:ring-blue-500/50',
    enterprise: 'bg-purple-600 text-white hover:bg-purple-700 shadow-md hover:shadow-lg focus:ring-purple-500/50',
